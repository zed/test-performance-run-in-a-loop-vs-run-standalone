* [how to handle cpu cache in python ( or fastest way to call a function once)][http://stackoverflow.com/questions/32163585/how-to-handle-cpu-cache-in-python-or-fastest-way-to-call-a-function-once]
