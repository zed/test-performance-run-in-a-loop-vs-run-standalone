...
[[https://api.travis-ci.org/zed/test-performance-run-in-a-loop-vs-run-standalone.svg?branch=master][https://travis-ci.org/zed/test-performance-run-in-a-loop-vs-run-standalone]]
